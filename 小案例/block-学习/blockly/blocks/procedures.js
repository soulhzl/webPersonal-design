...
Blockly.Procedures.color = blocksColor['catFunction']
...
Blockly.Blocks['procedures_defnoreturn'] = {
	...
	init: function() {
		...
		**/
		this.setColour(Blockly.Procedures.color);
	...
	updateParams_: function() {
		...
		if (this.arguments_.length) {
			paramString = Blockly.Msg.PROCEDURES_BEFORE_PARAMS +
				' ' + this.arguments_.join(', ') + ' ' + Blockly.Msg.PROCEDURES_BEFORE_PARAMS2;
		}
...
Blockly.Blocks['procedures_mutatorarg'] = {
	...
	init: function() {
		...
		// /field.setAttribute("type", "procedures_defnoreturn");
...
Blockly.Blocks['procedures_callnoreturn'] = {
	...
	mutationToDom: function() {
		...
		for (var i = 0; i < this.arguments_.length; i++) {
			...
			//parameter.setAttribute('name', 'input_bool_inline');
